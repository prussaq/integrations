...
api = get_api(config.CREDS, config.HTX_API)
...
# data = account.query_position_info_isolated(api, {'contract_code': 'OP-USDT'})
# data = unified_account.query_unified_account_assets(api)
data = account.query_account_financial_records_isolated(api, 'LUNA-USDT', {"contract":'LUNA-USDT', "type":'30,31'})
